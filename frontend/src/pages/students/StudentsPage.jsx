        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 text-sm">Manage student records and boarding assignments.</p>
                </div>
                    ...
                    {loading ? (
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {students.length === 0 ? (
                                    <TableRow>
                                        <TableCell colSpan={6} className="text-center py-10 text-slate-400">No students found.</TableCell>
                                    </TableRow>
                                    ...
                                    <TableRow key={student.id}>
                                        ...
                                        <TableCell>
                                            ...
                                            {student.year_level && <span className="text-xs text-slate-400 ml-1">· {student.year_level}</span>}
                                        </TableCell>
                                        <TableCell>
