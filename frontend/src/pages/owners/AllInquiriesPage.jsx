...
import {
    BookOpen, Mail, Phone, Clock,
    CheckCircle, XCircle, AlertCircle, Filter, RefreshCw, Building2, MessageCircle
} from 'lucide-react';
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span
                                                        ...
                                                        onClick={() => navigate(`/boarding-houses/${res.boarding_house_id}`)}
                                                    >
                                                        {res.boarding_house?.boarding_name || 'Unknown'}
                                                    </span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
